...
// Kurs1.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKurs1App, CWinApp)
...
// Единственный объект CKurs1App

CKurs1App theApp;


// инициализация CKurs1App

BOOL CKurs1App::InitInstance()
{
